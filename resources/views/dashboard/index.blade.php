    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="/"><img src="template/assets/assets/images/logomink.jpg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="/"><img src="template/assets/assets/images/logomink.jpg" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="assets/images/fotoprofil.png" alt="">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Regristasi</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/regristasi-nasabah">Regristasi Nasabah</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Regristasi Staff</a></li>
          ...
          <!-- <li class="nav-item menu-items">
            <a class="nav-link" href="">
              ...
              <span class="menu-title">uuuu</span>
            </a>
          </li> -->
          <li class="nav-item menu-items">
                          ...
                          <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-sm-flex flex-grow">
                              <div class="flex-grow">
                                ...
                                <p class="text-muted mb-0">Broadcast web app</p>
                              </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img src="assets/images/fotoprofil.png" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="template/assets/assets/images/2.png" alt="image" />
                              <span class="pl-2">Galih Putri</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Mini bank </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="template/assets/assets/images/1.png" alt="image" />
                              <span class="pl-2">Farrel Naufal</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Mini bank </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="template/assets/assets/images/5.png" alt="image" />
                              <span class="pl-2">Ilham R</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Mini bank </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="template/assets/assets/images/4.png" alt="image" />
                              <span class="pl-2">Kristian Budi</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Mini bank </td>
      ...
      <div class="row footer-top-29">
        <div class="col-lg-4 col-md-6 footer-list-29 footer-1 pr-lg-5">
          <div class="footer-logo mb-4">
            <a class="navbar-brand" href="#index.php"><img src="template/assets/assets/images/logo.png" alt="Your logo" title="Your logo" style="height:35px;"/> MINK</a>
          </div>
