                            ...
                            <div class="row">
                                    <div class="col-lg-6 bg-secondary rounded">
                                        ...
                                        <div class="my-3 col-sm-4">
                                            <img src="assets/images/fotoprofil.png" alt="img" class="img-fluid ml-3" />
                                        </div> 
                                        <div class="form-group col-sm-6 offset-1 my-5">
                                            ...
                                            <div class="row align-items-center mt-3">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" id="norekening" placeholder="Saldo">
                                                </div>
                                                <div class="col-1">
                                    ...
                                    <form class="my-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mt-1" id="norekening" placeholder="no rekening">
                                        </div>
                                        <div class="form-group">
                                            <h5 style="font-size: 15px;">Pengeluaran Bulan ini</h5>
                                            <input type="text" class="form-control mt-1" id="pengeluaran" placeholder="pengeluaran">
                                        </div>
                                        <div class="form-group">
                                            <h5 style="font-size: 15px;">Pemasukan Bulan ini</h5>
                                            <input type="text" class="form-control mt-1" id="pemasukan" placeholder="pemasukan">
                                        </div>
                                    </form>
                                    </div>   
                            </div> 
    ...
    <div class="mobile-info py-lg-5 py-md-4 py-2">
        ...
        <div class="container ">
            ...
            <tbody>
                <tr>
                    <td>
                        <h4>a.n {{ Auth::user()->name }} to Kristian</h4>
                        <p>18-06-2022</p>
                    </td>
                    <td class="text-right">
                        <h4>-Rp200.000</h4>
                ...
                <tr>
                    <td>
                        <h4>a.n {{ Auth::user()->name }} to Ilham Nur</h4>
                        <p>18-06-2022</p>
                    </td>
                    <td class="text-right">
                        <h4>-Rp500.000</h4>
